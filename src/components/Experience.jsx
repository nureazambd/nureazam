...
<div className="flex flex-col text-left w-full mb-2">
    <h1 className="lg:w-2/3 uppercase leading-relaxed text-[18px] font-semibold text-[#aaa6c3]">What I have done so far</h1>
      <h1 className="sm:text-6xl text-6xl font-black title-font mb-2 text-gray-50">Work Experience.</h1>
    </div>
