...
function Education() {
  return (
    ...
    {/* text-[17px] font-semibold text-[#aaa6c3] */}
        <div >
        <h3 className='text-white-100 text-[24px] font-bold'>North South University</h3>
        <p className='text-white-100 text-[16px] font-semibold' style={{ margin: 0 }}>
